...
public class StlSemanticSequencer extends AbstractDelegatingSemanticSequencer {
	 ...
	 *
	 * Constraint:
	 *     (name=ID cost=EInt inputSlots+=Slot outputSlots+=Slot services+=Service*)
	 */
	 ...
	 *
	 * Constraint:
	 *     (name=ID generatedType=[ItemType|QualifiedName] cost=EInt outputSlots+=Slot services+=Service*)
	 */
	 ...
	 *
	 * Constraint:
	 *     (name=ID cost=EInt capacity=EInt inputSlots+=Slot services+=Service*)
	 */
	 ...
	 * Constraint:
	 *     (
	 *         (name=ID cost=EInt reliability=EDouble processingTime=EInt) | 
	 *         (name=ID cost=EInt reliability=EDouble processingTime=EInt parameters+=Parameter+)
	 *     )
	 */
