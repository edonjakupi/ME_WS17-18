...
public class ConnectorItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	protected void addTargetComponentPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Connector_targetComponent_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Connector_targetComponent_feature",
								"_UI_Connector_type"),
						StlPackage.Literals.CONNECTOR__TARGET_COMPONENT, true, false, true, null, null, null));
	}
	...
	protected void addSourceComponentPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Connector_sourceComponent_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Connector_sourceComponent_feature",
								"_UI_Connector_type"),
						StlPackage.Literals.CONNECTOR__SOURCE_COMPONENT, true, false, true, null, null, null));
	}
